...
void ThoiGian::Nhap()
{
	while (true)
	{
		...
		if (cin >> iGio >> iPhut >> iGiay)
		{
			...
			else if (iGio > 23||iGio<0) cout << "Gio khong hop le.\n";
			else if (iPhut > 59 || iPhut < 0) cout << "Phut khong hop le.\n";
			else if (iGiay > 59 || iGiay < 0) cout << "Giay khong hop le.\n";
		}
		else
		{
